...
- monastry gate/outer cloiser 
    ...
    - WP near cross shape, exit is NE
    - if WP SE of fountain, exit is NW
    - if WP NW of fountain, exist is SE
...
- dry hills (far oasis: some other corner, halls of the dead: random inside, WP: random inside)
    - (optional) can kill beetleburst near WP for XP
- halls of dead 1-2 (exit: left)
- halls of dead 3 (horadric cube: left)
- far oasis (lost city: some other corner: maggot lair: random inside, WP: random inside)
- maggot lair 1-2 (exit: right)
- maggot lair 3 (staff of kings: straight)
- lost city (valley of the snakes: some corner, NOT the south corner, WP: random inside)
...
- palace cellar 3 (fixed layout, exit: center)
    - fire eye is hall/room past exit room*
- arcane sancuary (exit: random, WP: center)
- canyon of the magi (fixed layout, tombs from left to right: ○ ◡ ☐ ⊹ ≫ △ ⚇)
    - check quest log for real tomb symbol
...
- river of flame (exit: straight, WP: straight)
    - hephasto off to the side
- (hell run/optional) kill hephasto for hammer and break mephisto's soulstone 
...
- arreat plateau (exit: forward)
    ...
    - WP random (skip)
- crystaline passage (glacial trail: left, frozen river: straight, WP: right)
- (hell run/optional) frozen river (fixed layout)
    - talk ta anya, TP back talk to malah for potion, talk to anya, talk to malah for +res scroll, talk to anya in town for rare class item
